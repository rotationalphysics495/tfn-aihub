...
async function seed() {
  ...
  const dailySummaries = [
    ...
    // ============ 9 DAYS AGO (daysAgo(9)) - Required for week-over-week on daysAgo(2) = 2026-02-20 ============
    // These values are compared against daysAgo(2) to compute weekOverWeekChange for that report date.
    { asset_id: 'a0000001-0000-0000-0000-000000000014', report_date: daysAgo(9), oee_percentage: 88.20, actual_output: 1720, target_output: 1950, downtime_minutes: 48, waste_count: 26, financial_loss_dollars: 140.00, downtime_reasons: { "Mechanical Failure": 30, "Cleanup": 18 }, smart_summary_text: 'Grinder 5 baseline week prior.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000004', report_date: daysAgo(9), oee_percentage: 87.30, actual_output: 1703, target_output: 1950, downtime_minutes: 52, waste_count: 29, financial_loss_dollars: 155.00, downtime_reasons: { "Material Issue": 32, "Changeover": 20 }, smart_summary_text: 'Grinder 1 baseline week prior.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000005', report_date: daysAgo(9), oee_percentage: 94.10, actual_output: 1835, target_output: 1950, downtime_minutes: 18, waste_count: 10, financial_loss_dollars: 50.00, downtime_reasons: { "Changeover": 18 }, smart_summary_text: 'Grinder 2 strong baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000001', report_date: daysAgo(9), oee_percentage: 91.20, actual_output: 130, target_output: 143, downtime_minutes: 15, waste_count: 2, financial_loss_dollars: 83.33, downtime_reasons: { "Changeover": 10, "Cleanup": 5 }, smart_summary_text: 'Roaster 1 solid baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000002', report_date: daysAgo(9), oee_percentage: 95.80, actual_output: 137, target_output: 143, downtime_minutes: 8, waste_count: 0, financial_loss_dollars: 37.50, downtime_reasons: { "Cleanup": 8 }, smart_summary_text: 'Roaster 2 consistent baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000007', report_date: daysAgo(9), oee_percentage: 91.50, actual_output: 1784, target_output: 1950, downtime_minutes: 35, waste_count: 20, financial_loss_dollars: 87.50, downtime_reasons: { "Changeover": 22, "Cleanup": 13 }, smart_summary_text: 'Roaster 3 steady baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000008', report_date: daysAgo(9), oee_percentage: 90.50, actual_output: 4163, target_output: 4600, downtime_minutes: 30, waste_count: 15, financial_loss_dollars: 70.83, downtime_reasons: { "Changeover": 20, "Cleanup": 10 }, smart_summary_text: 'Filler Line A clean baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000009', report_date: daysAgo(9), oee_percentage: 89.40, actual_output: 4112, target_output: 4600, downtime_minutes: 36, waste_count: 20, financial_loss_dollars: 79.17, downtime_reasons: { "Changeover": 24, "Cleanup": 12 }, smart_summary_text: 'Filler Line B consistent baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000010', report_date: daysAgo(9), oee_percentage: 84.20, actual_output: 3368, target_output: 4000, downtime_minutes: 52, waste_count: 30, financial_loss_dollars: 120.83, downtime_reasons: { "Material Shortage": 28, "Changeover": 24 }, smart_summary_text: 'Filler Line C material issues baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000011', report_date: daysAgo(9), oee_percentage: 89.20, actual_output: 5530, target_output: 6200, downtime_minutes: 38, waste_count: 52, financial_loss_dollars: 66.25, downtime_reasons: { "Changeover": 24, "Label Issue": 14 }, smart_summary_text: 'Pack Line A consistent baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000012', report_date: daysAgo(9), oee_percentage: 88.10, actual_output: 5462, target_output: 6200, downtime_minutes: 45, waste_count: 58, financial_loss_dollars: 72.50, downtime_reasons: { "Changeover": 28, "Label Issue": 17 }, smart_summary_text: 'Pack Line B standard baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000013', report_date: daysAgo(9), oee_percentage: 87.10, actual_output: 4878, target_output: 5600, downtime_minutes: 52, waste_count: 74, financial_loss_dollars: 82.50, downtime_reasons: { "Case Erector": 33, "Changeover": 19 }, smart_summary_text: 'Pack Line C modest baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000006', report_date: daysAgo(9), oee_percentage: 89.10, actual_output: 1737, target_output: 1950, downtime_minutes: 40, waste_count: 26, financial_loss_dollars: 125.00, downtime_reasons: { "Changeover": 26, "Cleanup": 14 }, smart_summary_text: 'Filler Line D baseline.' },
    { asset_id: 'a0000001-0000-0000-0000-000000000003', report_date: daysAgo(9), oee_percentage: 88.00, actual_output: 126, target_output: 143, downtime_minutes: 20, waste_count: 2, financial_loss_dollars: 166.67, downtime_reasons: { "Changeover": 14, "Cleanup": 6 }, smart_summary_text: 'Roaster 4 steady baseline.' },
